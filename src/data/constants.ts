...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Dr. D Y PATIL UNIVERSITY, RAIT",
    description: [
      "Specializing in Artificial Intelligence and Machine Learning.",
      "Studying Data Structures, Object-Oriented Programming (OOP), and Software Engineering Principles.",
      "Building highly complex projects such as adaptive AI systems and security detection systems.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.TS,
